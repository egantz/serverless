...
[Spotinst Functions](https://spotinst.com/products/spotinst-functions) is a Multi-Cloud Functions as a Service (FaaS) platform that utilizes affordable compute and network infrastracture.
